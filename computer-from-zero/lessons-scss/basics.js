(function () {
  ...
  lessons.push({
    ...
    physical:
      "ჩვეულებრივ ტერმინალში ერთი ბრძანება უყურებს ცვლილებებს: `sass styles.scss style.css`. აქ, ამ პლატფორმაზე, კომპილაცია ბრაუზერშივე ხდება — მარჯვნივ ხედავ, რა CSS-ად იქცევა შენი SCSS.",
