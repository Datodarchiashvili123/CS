(function () {
  ...
  lessons.push({
    ...
    shortTitle: "ALU",
    theory: "ALU არის CPU-ის ნაწილი, რომელიც რიცხვებზე მოქმედებებს ასრულებს. ის ერთდროულად ითვლის რამდენიმე ოპერაციას (შეკრება, AND, OR, XOR...) და „სელექტორი“ ირჩევს, რომელი შედეგი გამოიტანოს.",
      ...
      container.append(
        ...
        CFZ.el("div", { className: "breakdown-panel" }, [
          ...
          CFZ.el("p", {
            ...
            text: "ALU ერთდროულად ითვლის ყველა ოპერაციას. მერე სელექტორი (მულტიპლექსორი) მხოლოდ არჩეული ოპერაციის შედეგს ატარებს გამოსავალზე. აქტიური ბლოკი მწვანედ ინთება.",
          }),
