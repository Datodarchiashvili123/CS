(function () {
  ...
  lessons.push({
    ...
    theory: "კარიბჭეები ითვლიან, მაგრამ კომპიუტერს ბიტის დამახსოვრებაც სჭირდება. ამას აკეთებს პატარა უჯრედი — ტრიგერი (latch), რომელიც უკუკავშირით თავის მდგომარეობას ინახავს.",
