...
window.CFZExercises = {
  ...
  "scss-setup": {
    tasks: [
      { level: "easy", q: "რატომ ვერ დააკავშირებ .scss ფაილს პირდაპირ HTML-ში <link>-ით?" },
      { level: "easy", q: "Node-ით: რომელი ორი ბრძანება ჩართავს npm-ს და დააინსტალირებს Sass-ს?" },
      { level: "medium", q: "რას აკეთებს `sass --watch in.scss:out.css` და როდის გამოვიყენოთ?" },
    ],
    answers: [
      "ბრაუზერს მხოლოდ CSS ესმის; .scss ჯერ უნდა დაკომპილირდეს .css-ად, HTML-ში კი კომპილირებული .css აკავშირდება.",
      "npm init -y (package.json) და npm install -D sass.",
      "ფონში რჩება და ყოველ შენახვაზე ავტომატურად აკომპილირებს .scss → .css; მოსახერხებელია განვითარებისას.",
    ],
  },
  "scss-recap": {
    tasks: [
  ...
  "ng-intro": {
    tasks: [
      { level: "easy", q: "რომელ სამ ენას აერთიანებს Angular-ის კომპონენტი?" },
      { level: "medium", q: "რატომ გვჭირდება ფრეიმვორკი სუფთა JavaScript-ის ნაცვლად?" },
    ],
    answers: ["TypeScript (ლოგიკა), HTML (შაბლონი), CSS (სტილი).", "DOM-ის ხელით მართვა დიდ აპლიკაციაში რთულდება; Angular ეკრანის განახლებას თავად უზრუნველყოფს."],
  },
  "ng-component": {
    tasks: [
      { level: "easy", q: "რას განსაზღვრავს selector და რას template?" },
      { level: "medium", q: "რატომ იწყება selector პრეფიქსით (app-)?" },
    ],
    answers: ["selector — როგორ ჩაისმება HTML-ში; template — რა დაიხატება.", "რომ ჩვეულებრივ HTML ტეგებს არ აერიოს."],
  },
  "ng-interpolation": {
    tasks: [
      { level: "easy", q: "რა შეიძლება ჩაიწეროს {{ }}-ში და რა არა?" },
      { level: "medium", q: "როგორ იცავს ინტერპოლაცია XSS-ისგან?" },
    ],
    answers: ["შეიძლება გამოსახულება და მეთოდის გამოძახება; არ შეიძლება მინიჭება, new, ციკლი.", "HTML ტეგები ტექსტად გამოჩნდება და არა კოდად."],
  },
  "ng-property-binding": {
    tasks: [
      { level: "easy", q: "რა განსხვავებაა src=\"x\"-სა და [src]=\"x\"-ს შორის?" },
      { level: "medium", q: "დაწერე ბმა, რომელიც ღილაკს დაბლოკავს ცვლადის მიხედვით." },
    ],
    answers: ["პირველი ტექსტია, მეორეში ბრჭყალებში გამოსახულებაა.", '[disabled]="dablokilia"'],
  },
  "ng-event-binding": {
    tasks: [
      { level: "easy", q: "როგორ დავუსმინოთ დაჭერას შაბლონში?" },
      { level: "medium", q: "როგორ მივიღოთ მოვლენის ობიექტი?" },
    ],
    answers: ['(click)="metodi()"', "$event-ით: (input)=\"shecvla($event)\""],
  },
  "ng-ngif": {
    tasks: [
  ...
  "ng-signals": {
    tasks: [
      { level: "easy", q: "როგორ იკითხება სიგნალის მნიშვნელობა შაბლონში?" },
      { level: "medium", q: "რა მოხდება, თუ ფრჩხილებს დაივიწყებ: {{ count }}?" },
    ],
    answers: ["{{ count() }} — ფრჩხილებით.", "დაიბეჭდება ფუნქცია და არა მნიშვნელობა."],
  },
  "ng-signal-update": {
    tasks: [
      { level: "easy", q: "რა განსხვავებაა set()-სა და update()-ს შორის?" },
      { level: "medium", q: "როგორ დავამატოთ ელემენტი მასივის სიგნალში?" },
    ],
    answers: ["set ახალ მნიშვნელობას აყენებს; update ძველიდან ითვლის.", "items.update(a => [...a, axali]) — ახალი მასივი."],
  },
  "ng-computed": {
    tasks: [
      { level: "easy", q: "დაწერე computed, რომელიც სიგნალს ორზე ამრავლებს." },
      { level: "medium", q: "შეიძლება თუ არა computed-ის პირდაპირ შეცვლა?" },
    ],
    answers: ["double = computed(() => this.count() * 2)", "არა — ის მხოლოდ იკითხება."],
  },
  "ng-input": {
    tasks: [
  ...
  "ng-service": {
    tasks: [
      { level: "easy", q: "რა განსხვავებაა კომპონენტსა და სერვისს შორის?" },
      { level: "medium", q: "რატომ ჯობია ლოგიკა სერვისში?" },
    ],
    answers: ["კომპონენტი ინტერფეისზეა, სერვისი — მონაცემებსა და ლოგიკაზე.", "ხელახლა გამოსაყენებელი და ადვილად სატესტია."],
  },
  "ng-di": {
    tasks: [
      { level: "easy", q: "როგორ ვიღებთ სერვისს თანამედროვე Angular-ში?" },
      { level: "hard", q: "რატომ ხედავს ორი კომპონენტი ერთსა და იმავე მონაცემს?" },
    ],
    answers: ["inject(MyService)", "სერვისი სინგლტონია — ერთხელ იქმნება და ყველა მისი მთხოვნელი იმავე ეგზემპლარს იღებს."],
  },
  "ng-lifecycle": {
    tasks: [
      { level: "easy", q: "როდის გამოიძახება ngOnInit?" },
      { level: "medium", q: "რისთვის არის ngOnDestroy და რა მოხდება მის გარეშე?" },
    ],
    answers: ["კომპონენტის შექმნისა და @Input-ების მიღების შემდეგ.", "გასუფთავებისთვის; მის გარეშე ტაიმერები/გამოწერები აგრძელებენ მუშაობას — მეხსიერების გაჟონვა."],
  },
  "ng-forms": {
    tasks: [
      { level: "easy", q: "როგორ ავიღოთ ველის მნიშვნელობა?" },
      { level: "medium", q: "რა არის Reactive Forms და როდის გამოვიყენოთ?" },
    ],
    answers: ["(input)=\"f($event)\" და $event.target.value", "FormControl/FormGroup-ზე აგებული მიდგომა — დიდი და რთული ვალიდაციის მქონე ფორმებისთვის."],
  },
  "ng-list-app": {
    tasks: [
      { level: "medium", q: "რატომ უნდა დავაბრუნოთ ახალი მასივი update()-ში?" },
      { level: "hard", q: "დაამატე წაშლის ღილაკი სიის თითო პუნქტს." },
    ],
    answers: ["ძველის პირდაპირ შეცვლა (push) შეიძლება ვერ შეამჩნიოს.", '(click)="washla(t)" და sia.update(a => a.filter(x => x !== t))'],
  },
  "ng-pipes": {
    tasks: [
      { level: "easy", q: "დაასახელე 4 ჩაშენებული პაიპი." },
      { level: "medium", q: "რატომ არ უნდა ჩავდოთ პაიპში მძიმე გამოთვლა?" },
    ],
    answers: ["uppercase, date, currency, json (ასევე async, number).", "ის ხშირად სრულდება და აპლიკაციას ანელებს."],
  },
  "ng-styles": {
    tasks: [
      { level: "easy", q: "როგორ დავამატოთ კლასი დინამიკურად?" },
      { level: "medium", q: "რას ნიშნავს სტილის იზოლაცია კომპონენტში?" },
    ],
    answers: ['[class.aqtiuri]="piroba" ან [ngClass]', "კომპონენტის CSS მხოლოდ მასზე მოქმედებს და სხვას ვერ გააფუჭებს."],
  },
  "ng-standalone": {
    tasks: [
  ...
  "ng-routing": {
    tasks: [
      { level: "easy", q: "რა არის SPA და როგორ მუშაობს Router?" },
      { level: "medium", q: "რატომ უნდა იყოს \"**\" მარშრუტი ბოლოს?" },
    ],
    answers: ["ერთგვერდიანი აპლიკაცია — მისამართის ცვლილებისას გვერდი არ იტვირთება, მხოლოდ კომპონენტი იცვლება.", "ის ყველა მისამართს იჭერს — ზემოთ რომ იყოს, დანარჩენებამდე ვერ მიაღწევდი."],
  },
  "ng-http": {
    tasks: [
  ...
  "ng-cli": {
    tasks: [
      { level: "easy", q: "დაასახელე 4 ძირითადი ng ბრძანება." },
      { level: "medium", q: "რატომ ჯობია ng generate ხელით ფაილების შექმნას?" },
    ],
    answers: ["ng new, ng serve, ng generate, ng build.", "ის სწორ სტრუქტურასა და სახელებს იცავს — გუნდში თანმიმდევრულობა რჩება."],
  },
  "ng-best-practices": {
    tasks: [
      { level: "medium", q: "დაასახელე Angular-ის 5 საუკეთესო პრაქტიკა." },
      { level: "hard", q: "როგორ შევამოწმოთ, სწორად გვაქვს თუ არა ლოგიკა გამოყოფილი?" },
    ],
    answers: [
      "პატარა კომპონენტები, ლოგიკა სერვისში, მდგომარეობა სიგნალებში, მონაცემი ქვემოთ/მოვლენა ზემოთ, ngOnDestroy-ში გასუფთავება.",
      "კითხვით: „ინტერფეისს რომ სრულად შევცვლი, რამდენი კოდი დამრჩება?“ — თუ ბევრი, სწორადაა.",
    ],
  },
  "ng-recap": {
    tasks: [
      { level: "medium", q: "ააწყვე TODO აპლიკაცია: სერვისი, სიგნალი, დამატება და წაშლა." },
      { level: "hard", q: "დაშალე ორ კომპონენტად: სია და ფორმა, @Input/@Output-ით დაკავშირებული." },
    ],
  },
  "ng-resources": {
    tasks: [
      { level: "easy", q: "გახსენი angular.dev-ის ინტერაქტიული სახელმძღვანელო და გაიარე პირველი ნაბიჯები." },
      { level: "medium", q: "შექმენი პროექტი StackBlitz-ზე და გადაიტანე იქ ერთი გაკვეთილის კოდი." },
    ],
  },
